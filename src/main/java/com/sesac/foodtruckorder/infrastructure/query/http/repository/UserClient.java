...
public interface UserClient {
    ...
    Result<List<OrderResponseDto.GetUserNameMap>> getUsers(@RequestHeader(value="Authorization", required = true) String authorizationHeader,
    ...
    default Map<Long, String> getUserNameMap(String authorizationHeader, Iterable<Long> userIds) {
        ...
        List<OrderResponseDto.GetUserNameMap> data = this.getUsers(authorizationHeader, userIds).getData();
        return data.stream()
                .collect(
                        Collectors.toMap(
